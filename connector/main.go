...
import (
	...
	"fmt"
	"log"
	"os"      // Adicionando o pacote os para acessar variáveis de ambiente
...
func main() {
	...
	// Obtendo o usuário e senha das variáveis de ambiente
	...
	opts.SetUsername(mqttUsername) // Usando o usuário da variável de ambiente
	opts.SetPassword(mqttPassword) // Usando a senha da variável de ambiente
